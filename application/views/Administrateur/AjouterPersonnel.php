...
echo form_input('NomPersonnel','',array('pattern' =>'^[a-zA-Z]{3,24}$','required'=>'required')).'<BR>';

echo form_label("Prenom : ", 'lbltPrenom');
echo form_input('PrenomPersonnel','',array('pattern' =>'^[a-zA-Z]{3,24}$','required'=>'required')).'<BR>';
